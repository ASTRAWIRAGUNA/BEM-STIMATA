            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-6">
                    <div class="flex justify-between mb-5">
                        ...
                        <a href="{{ route('inventories.create') }}" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 items-center py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 " type="button" >
